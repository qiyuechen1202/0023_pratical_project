...
---
### This slide is made for install package
```{r echo=FALSE}
...
1. it's 1 for both, R knows it's a list.
1. List. 
1. List 
--
The break in a slide, meaning you have to click to advance on the specfic slide... 
...
.pull-right[
  To have things on the right/ The right hand side
]
...
## This is Sub heading
---
## This is image locally
[make a link](https://www.rawpixel.com/image/440230/free-photo-image-nasa-russia-earth)
```{r echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics('img/Lena-river.jpeg')
```


---
## This is image loaded by url and have a link
There are not align with each other
[make a link](https://www.rawpixel.com/image/440230/free-photo-image-nasa-russia-earth)
...
.pull-left[
  ![Lena River](img/Lena-river.jpeg)
]
...
---
## Equations
values / text in an opening $$ and closing $$e.g.
split equations if they are rather long…with \begin{split}
and \\ where you want the splits and then \end{split}
